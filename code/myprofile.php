...
<div class="row">
 ...
 <div class="col-sm-4">
        ...
        <button onclick="location.href='postnow.php'">Post Now</button>
  ...
  <main>
  <br><br>
 <div class="col" style="border:2px solid white;">
    ...
    while ($r = mysqli_fetch_array($res)) {
      ...
      echo "<div id='img' class='imgcolumn'>";
        ...
        echo '<a href="data:image/jpg;base64,'.base64_encode( file_get_contents($r['image']) ).'" download><img src="download.png" class="download"></a>';
          //echo '<a href="index.php?download='. $r['id'].'" class="download_btn"><img src="download.png" class="download"></a>';
