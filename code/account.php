...
<div class="col-sm-8" style="border:5px solid #f00;">
<div class="container">
<h1>Instagram</h1></div>
...
<div id="id01" class="modal">
    ...
    <div class="container">
      ...
      <input type="file" name="myfile">choose from computer</input>
...
<button id="upload" type="submit" name="postimage" href="">Post Now</button>
</div>
</div>
<div class="col-sm-2" style="background-color:#CC3366">
<button <?php
